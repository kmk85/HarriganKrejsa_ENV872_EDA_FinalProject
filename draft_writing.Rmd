...
Using these elephant trail data for the preliminary analyses we have presented in this project provides an initial exploration into the uses for these data. In future studies, these data could be used to see how the trails change due to human disturbance or presence or at how elephants change course or not. There are also opportunities with these data to look at the change of vegetation along the heavier trodden trails and if it will affect the reproduction, seed dispersal or the types of plants that come up in the opened spaces in the forest. 
